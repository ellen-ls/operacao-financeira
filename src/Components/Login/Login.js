    ...
    <div className="bg-gradient-to-t from-[#0056FE] to-[#2E3CBD] text-white flex justify-center items-center min-h-screen p-4">
      <main className="grid w-full max-w-sm backdrop-blur-sm">
        <div className="grid grid-cols-2 cursor-pointer text-base relative isolate">
          <label
            id="tab-1"
            className={`cursor-pointer ${activePanel === 'signin' ? 'bg-white border-x border-teal-200/50 text-[#0056FE]  py-4 px-6 text-center text-gray-800 transition-all duration-300' : ''}`}
          ...
          <label
            id="tab-2"
            className={`cursor-pointer ${activePanel === 'signup' ? 'bg-white border-x border-teal-200/50 text-[#0056FE] py-4 px-6 text-center text-gray-800 transition-all duration-300' : ''}`}
            ...
            <div id="panel-1"  className="space-y-8">
              <form className='space-y-4 bg-white'>
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <a href="javascript:void(0)" className="text-xs">Forgot Password</a>
                </div>
            ...
            <div id="panel-2" className="space-y-8">
              <form className="space-y-4">
                ...
                <div className="mt-4 flex items-center justify-center gap-4">
                  <div className="tick">
                    <input type="radio" name="gender" id="gender-1" className="peer sr-only" />
                    <label htmlFor="gender-1" className="flex items-center gap-2 cursor-pointer transition-all duration-300">
                      <div>
                        <span className="material-symbols-outlined"></span>
                        <span className="material-symbols-outlined"></span>
                      </div>
                  ...
                  <div className="tick">
                    <input type="radio" name="gender" id="gender-2" className="peer sr-only" />
                    <label htmlFor="gender-2" className="flex items-center gap-2 cursor-pointer transition-all duration-300">
                      <div>
                        <span className="material-symbols-outlined"></span>
                        <span className="material-symbols-outlined"></span>
                      </div>
