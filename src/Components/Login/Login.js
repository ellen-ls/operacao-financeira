          ...
          {activePanel === 'signin' && (
            <div id="panel-1"  className="space-y-8">
              ...
              <form className='space-y-4 '>
                <div className="field flex items-center justify-between border-b border-sky-700 relative px-2 text-black">
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <a className="text-xs text-black">Forgot Password</a>
                </div>
                <button type="button" className="uppercase text-lg py-3 px-4 bg-sky-700 text-white relative isolate w-full flex items-center justify-center gap-2 overflow-hidden ring-0 outline-none before:absolute before:inset-0 before:-z-10 before:opacity-0 before:transition-all before:duration-300 before:ease-out before:bg-[#2f285a] hover:before:opacity-100 focus-visible:before:opacity-100"
              ...
              <button type="button" className="!bg-[#4267B2] py-3 px-4 bg-sky-700 text-white relative isolate w-full flex items-center justify-center gap-2 overflow-hidden ring-0 outline-none before:absolute before:inset-0 before:-z-10 before:opacity-0 before:transition-all before:duration-300 before:ease-out before:bg-[#2f285a] hover:before:opacity-100 focus-visible:before:opacity-100">
